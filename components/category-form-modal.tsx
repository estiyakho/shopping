...
export function CategoryFormModal({
  ...
  const addCategory = useShoppingStore((state) => state.addCategory);
  const updateCategory = useShoppingStore((state) => state.updateCategory);
  const accentColor = useShoppingStore((state) => state.settings.accentColor);
